...
справжній. У панелі емулятора введи `221-3351-753` у поле тексту і натисни **Scan**: застосунок отримає
...
Порівняй те, що застосунок отримав, з тим, що ти відправив. Якщо перший символ зайвий або бракує —
